...
class ImagePickerViewController: BaseViewController {
    ...
    /// 顶部滚动切换的titles
    private lazy var titles = ["普通", "cell"]
    /// 包含的所有视图数组, 须遵守JXSegmentedListContainerViewListDelegate
    private lazy var vcs: [JXSegmentedListContainerViewListDelegate] = [ImagePicker1ViewController(),
                                                                        ImagePicker2ViewController()]
}
...
extension ImagePickerViewController: JXSegmentedListContainerViewDataSource {
